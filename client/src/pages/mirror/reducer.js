import { CURRENT_MIRROR, UPDATE_WEATHER, MIRROR_DELETE_REQUEST, MIRROR_DELETE_SUCCESS, MIRROR_DELETE_FAILURE, SECTION_DELETE_REQUEST, SECTION_DELETE_SUCCESS, SECTION_DELETE_FAILURE, OPTION_DELETE_REQUEST, OPTION_DELETE_SUCCESS, OPTION_DELETE_FAILURE, SECTION_POST_FAILURE, SECTION_POST_REQUEST, SECTION_POST_SUCCESS, MIRROR_POST_FAILURE, MIRROR_POST_REQUEST, MIRROR_POST_SUCCESS, MIRROR_GET_FAILURE, MIRROR_GET_REQUEST, MIRROR_GET_SUCCESS, FETCH_WEATHER_FAILURE, FETCH_WEATHER_REQUEST, FETCH_WEATHER_SUCCESS } from './types';
...
// Current Mirror Edit
    case CURRENT_MIRROR:
      return { ...state, isRequesting: false, currentMirror: action.currentMirror };
